...
public class InventoryActions {
	...
	public static final RegistryObject<SoundEvent> SOLIDIFY_CONCRETE = DEFERRED_SOUND_EVENTS.register("solidify_concrete", () -> new SoundEvent(new ResourceLocation(ActionsConstants.MODID, "solidify_concrete")));
