...
public class ActionConditionType {
	...
	public static final Supplier<IForgeRegistry<ActionConditionType>> CONDITION_TYPES = DEFERRED_ACTION_CONDITION_TYPES.makeRegistry(
