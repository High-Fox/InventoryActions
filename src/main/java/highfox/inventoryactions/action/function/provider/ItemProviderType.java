...
public class ItemProviderType extends ForgeRegistryEntry<ItemProviderType> {
	...
	public static final Supplier<IForgeRegistry<ItemProviderType>> PROVIDER_TYPES = DEFERRED_PROVIDER_TYPES.makeRegistry(ItemProviderType.class,
